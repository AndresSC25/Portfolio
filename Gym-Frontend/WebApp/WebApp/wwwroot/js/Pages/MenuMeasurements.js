document.addEventListener("DOMContentLoaded",
    function() {
        ...
        const pages = {
            Admin: [".createMeasureAppointment", ".measurementForm", ".measurementList"],
            Recepcionista: [".createMeasureAppointment", ".measurementList"],
            Entrenador: [".measurementForm", ".measurementList"],
            Cliente: [""]
        };
